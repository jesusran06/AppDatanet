            ...
            <div class="modal-content"> 
                ...
                <div class="container-fluid">
                    <div class="row my-4">
                        ...
                        <div class="col-md-4">
                            <span class="h5"><strong>Documento: </strong> {{ (request.type_client == 'N' || request.type_client == 'n') ? request.document2 : request.document}}</span>
                        </div>
                        <div class="col-md-4">
                            <span class="h5"><strong>Email:</strong> {{  request.email }}</span>
                        </div>

                    </div>
                    <div class="row my-4">
                        <div class="col-md-4">
                            <span class="h5"><strong>Tel/Wsp</strong> {{  request.celphone+'/'+request.whatsapp }}</span>
                            
                        </div>
                        <div class="col-md-4">
                            <span class="h5"><strong>Dirección:</strong> {{  request.address }}</span>
                      ...
                      <div class="col-8">
                        <table class="table table-hover table-sm table-striped">
                          ...
                          <tbody>
                            <tr>
                                <td>Instalación</td>
                                <td class="text-center">{{  parseFloat(request.instalation.total_cost).toFixed(2) }}<strong></strong></td>
                            </tr>
                            <tr>
                            ...
                            <tr v-if="request.cable == 1">
                                <td>Abono Cable</td>
                                <td class="text-center">{{  parseFloat(request.mount_cable).toFixed(2) }}<strong></strong></td>
                            </tr>
                            <tr v-if="request.prorateo == 1">
                                <td>Prorateo</td>
                                <td class="text-center">{{  parseFloat(request.mount_prorateo).toFixed(2) }}<strong></strong></td>
                            </tr>
                             <tr v-if="request.router == 1">
                                <td>{{ request.router_model.name }}</td>
                                <td class="text-center">{{ parseFloat(request.router_model.price).toFixed(2)  }}<strong></strong></td>
                            </tr>
                         </tbody>
                         <tfoot>
                            ...
                            <td class="text-capitalize text-center">
                              <p class="h4"><strong>{{ parseFloat(request.invoice_total).toFixed(2) }}</strong></p>
                            </td>
                    ...
                    <div class="row justify-content-center">
                      <div class="col-sm-4 text-center">
                        <h4 class="mb-0">Formas de Pagos</h4>
                      </div>
                    </div>
                    <div class="row justify-content-center">
                      <div class="col-8">
                        <table class="table table-hover table-sm table-striped">
                          ...
                          <tbody>
                            <tr v-for="it in request.paid_forms" :key="it.id">
                                <td>{{ it.name }}</td>
