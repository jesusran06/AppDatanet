    ...
    <div class="wrapper" id="app">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <router-link to="/dashboard" class="brand-link">
                <img src="{{ asset('/images/datanet_logo.jpeg') }}" alt="Datanet" class="brand-image img-circle elevation-3"
                    style="opacity: 1" width="50%" height="50%">
                <span class="brand-text font-weight-light">{{ 'En linea' }}</span>
            </router-link>
        ...
        <footer class="main-footer">
            ...
            {{-- Default to the left --}}
            <strong>Copyright &copy; 2022 <a href="https://datanet.com">DATANET C.A.</a></strong> Derechos Reservados.
        </footer>
    </div>
    {{-- ./wrapper --}}
